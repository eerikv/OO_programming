...
# Author:       Eerik Vainio
# Description:  A class MagicPotion, which is inherited by
#               SecretMagicPotion. MagicPotion has a name and
#               ingredients can be added to it. SecretMagicPotion
#               additionally asks for a password, which if input incorrectly
